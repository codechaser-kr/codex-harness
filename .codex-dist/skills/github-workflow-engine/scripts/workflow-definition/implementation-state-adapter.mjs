...
const SOURCE_CONTRACTS = new Map([
  ...
  ["review_comment_draft_usable", { sourceKind: "skill_output", sourceReference: "review-comment" }],
  ...
  ["review_comments_posted", { sourceKind: "github_state" }],
  ["review_feedback_inventory", { sourceKind: "github_state" }],
  ...
  ["feedback_result_comment_posted", { sourceKind: "github_state" }],
  ["feedback_resolution", { sourceKind: "user_input" }],
  ["feedback_resolution_reflected", { sourceKind: "github_state" }],
  ["remaining_feedback_status", { sourceKind: "local_state" }],
  ["pull_request_merge_decided", { sourceKind: "user_input" }],
