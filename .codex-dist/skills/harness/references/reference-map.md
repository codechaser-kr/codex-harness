...
- 현재 품질 문제가 어느 하네스 Phase의 부족함에서 시작됐는가
...
- 생성기가 타겟 프로젝트에서 운영 감사 판정과 품질 비교를 수행할 준비가 돼 있는가
- 하네스 Phase 6 판정 뒤 어떤 품질 비교와 피드백 반영이 필요한가
- 부족한 점이 입력 문서 품질 문제인지, 역할 규칙 문제인지, 운영 기준 문제인지
- 다음 재진입을 어느 하네스 Phase로 돌려야 하는가
...
성숙도 판정은 생성기 자체 준비도, 타겟 하네스 운영 감사 판정, 품질 비교의 세 축으로 나눠 본다. 생성기 기준은 `generator-readiness-checklist.md`, 실제 생성 결과 기준은 `target-evaluation-playbook.md`와 `quality-evaluation-guide.md`를 따른다.
...
- `SKILL.md`와 레퍼런스 묶음이 타겟 프로젝트에서 운영 감사 판정과 품질 비교를 수행할 준비가 돼 있는가
