...
- 어느 하네스 Phase부터 재진입해야 하는가
- 관찰된 구조·계약 문제가 어느 하네스 Phase와 연결되는가
...
- 현재 유지, 부분 수정, 구조 재설계 중 어떤 선택지를 사용자에게 제시할지
...
## 8. 하네스 Phase 7 사용자 확정 피드백 반영과 타겟 판단 지원

다음 질문에 답해야 할 때 먼저 읽는다.

- 생성기가 타겟 프로젝트에서 구조·계약 검증 결과와 사용자 판단 자료를 준비할 수 있는가
- 하네스 Phase 6 관찰 뒤 어떤 선택지와 영향 범위를 사용자에게 제시해야 하는가
- 관찰된 차이가 입력 문서, 역할 규칙, 운영 기준 중 어느 축과 연결되는가
- 사용자가 확정할 수 있도록 어떤 하네스 Phase 후보를 설명해야 하는가
...
생성기 자체 준비도는 `generator-readiness-checklist.md`로 점검한다. 타겟 하네스의 구조·계약 관찰과 선택지 준비는 `target-evaluation-playbook.md`, 비교 자료는 `quality-evaluation-guide.md`를 따르며 품질과 운영 적합성은 사용자가 최종 판단한다.
...
- QA가 파일 존재 확인을 넘어 경계면 교차 관찰 자료를 제공하는가
...
- `SKILL.md`와 레퍼런스 묶음이 타겟 프로젝트에서 구조·계약 검증과 사용자 판단 자료 준비를 수행할 수 있는가
...
- 하네스 Phase 7 사용자 확정 피드백 반영과 타겟 판단 지원:
  - `reference-map.md`
  - `evolution-contract.md`
  - `quality-evaluation-guide.md`
  - `target-evaluation-playbook.md`
