...
- 원본 하네스의 팀 아키텍처 패턴을 Codex의 주 에이전트 중심 실행과 보조 위임 구조로 어떻게 옮길까
...
- 원본 하네스의 `팀 아키텍처 / 실행 모드 / 역할 구성 / 오케스트레이션 흐름` 예시 구조를 Codex용 생성 기준으로 어떻게 바꿀까
...
- `SKILL.md`와 레퍼런스 묶음이 타겟 프로젝트에서 충분성 평가를 수행할 준비가 돼 있는가
