...
신규 구축에서는 생성 직후의 하네스도 자기진화 루프를 시작할 수 있어야 합니다. 초기 생성물은 다음 시작 역할, 다음 재진입 Phase, 학습 후보 기록 위치를 남겨야 하며, 이 기준은 `.codex-dist/skills/harness/references/initial-generation-contract.md`에서 관리합니다.
